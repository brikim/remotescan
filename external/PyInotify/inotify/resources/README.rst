...
Example::
    ...
    i = external.PyInotify.inotify.adapters.InotifyTree('/tmp/watch_tree')
...
Then, call "test.sh" to run the tests::
    ...
    $ ./test.sh
    test__cycle (tests.test_external.PyInotify.inotify.TestInotify) ... ok
    test__get_event_names (tests.test_external.PyInotify.inotify.TestInotify) ... ok
    test__international_naming_python2 (tests.test_external.PyInotify.inotify.TestInotify) ... SKIP: Not in Python 2
    test__international_naming_python3 (tests.test_external.PyInotify.inotify.TestInotify) ... ok
    test__automatic_new_watches_on_existing_paths (tests.test_external.PyInotify.inotify.TestInotifyTree) ... ok
    test__automatic_new_watches_on_new_paths (tests.test_external.PyInotify.inotify.TestInotifyTree) ... ok
    test__cycle (tests.test_external.PyInotify.inotify.TestInotifyTree) ... ok
    test__renames (tests.test_external.PyInotify.inotify.TestInotifyTree) ... ok
    test__cycle (tests.test_external.PyInotify.inotify.TestInotifyTrees) ... ok
